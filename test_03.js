// Fuel File: Mock Test 3 (Jumbled Conic Sections Theory)
...
window.testBank['test_03'] = {
    ...
    {
        "type": "mcq",
        "text": "Difference of the squares of any two conjugate semi-diameters of a hyperbola is:",
        "options": [
            "Constant (a<sup>2</sup> + b<sup>2</sup>)",
            "Constant (a<sup>2</sup> - b<sup>2</sup>)",
            "Variable depending on &theta;",
            "Constant (ab)"
        ],
        "correctAnswer": 1,
        "solution": "For a hyperbola, the difference is constant: CP<sup>2</sup> - CD<sup>2</sup> = a<sup>2</sup> - b<sup>2</sup>."
    },
    {
        "type": "mcq",
    ...
    },
    {
        ...
        "correctAnswer": 1,
        "solution": "Setting discriminant to 0 gives c<sup>2</sup> = a<sup>2</sup>m<sup>2</sup> + b<sup>2</sup>."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "The locus of the foot of the perpendicular drawn from the focus upon any tangent to an ellipse or hyperbola is:",
        "options": [
            "The directrix",
    ...
    {
        "type": "mcq",
        "text": "What is the length of the chord intercepted by the parabola y<sup>2</sup> = 4ax on the line y = mx + c?",
        "options": [
            "(4/m<sup>2</sup>) &radic;(a(1+m<sup>2</sup>)(a-mc))",
            "(4/m<sup>2</sup>) &radic;(1+m<sup>2</sup>)(a-mc)",
            "4 &radic;(a(1+m<sup>2</sup>)(a-mc))",
            "(4/m) &radic;(1+m<sup>2</sup>)(a-mc)"
        ],
        "correctAnswer": 0,
        "solution": "The length of the chord is (4/m<sup>2</sup>) &radic;(a(1+m<sup>2</sup>)(a-mc))."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "What is the condition for two lines y = m<sub>1</sub>x + c<sub>1</sub> and y = m<sub>2</sub>x + c<sub>2</sub> to be conjugate diameters of a hyperbola?",
        "options": [
            "m<sub>1</sub>m<sub>2</sub> = b<sup>2</sup>/a<sup>2</sup>",
            "m<sub>1</sub>m<sub>2</sub> = -b<sup>2</sup>/a<sup>2</sup>",
            "m<sub>1</sub>m<sub>2</sub> = a<sup>2</sup>/b<sup>2</sup>",
            "m<sub>1</sub>m<sub>2</sub> = -a<sup>2</sup>/b<sup>2</sup>"
        ],
        "correctAnswer": 0,
        "solution": "For a hyperbola, the product of slopes of conjugate diameters is m<sub>1</sub>m<sub>2</sub> = b<sup>2</sup>/a<sup>2</sup>."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "The eccentric angles of the ends of a pair of conjugate diameters differ by:",
        "options": [
            "&pi;",
            "&pi;/2",
            "&pi;/3",
        ...
        "correctAnswer": 1,
        "solution": "If one diameter has eccentric angle &theta;, its conjugate has &theta; &plusmn; &pi;/2. The difference is &pi;/2."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "If two tangents to a parabola y<sup>2</sup> = 4ax intersect at right angles, their chord of contact must be:",
        "options": [
            "The latus rectum",
            "A focal chord",
        ...
        "correctAnswer": 1,
        "solution": "Perpendicular tangents intersect on the directrix, and the chord of contact from any point on the directrix is a focal chord."
    },
    {
        "type": "mcq",
    ...
    },
    {
        ...
        "correctAnswer": 1,
        "solution": "Similar to the ellipse, the directrices are x = &plusmn;a/e, so the distance is 2a/e."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "Sum of the squares of any two conjugate semi-diameters of an ellipse is:",
        "options": [
            "Constant (a<sup>2</sup> + b<sup>2</sup>)",
            "Constant (a<sup>2</sup> - b<sup>2</sup>)",
            "Variable depending on &theta;",
        ...
        "correctAnswer": 0,
        "solution": "A key property: CP<sup>2</sup> + CD<sup>2</sup> = a<sup>2</sup> + b<sup>2</sup> (constant)."
    },
    {
        "type": "mcq",
        "text": "What is the equation of the director circle of x<sup>2</sup>/a<sup>2</sup> - y<sup>2</sup>/b<sup>2</sup> = 1?",
    ...
    {
        "type": "mcq",
        "text": "What is the condition for two lines y = m<sub>1</sub>x + c<sub>1</sub> and y = m<sub>2</sub>x + c<sub>2</sub> to be conjugate diameters of an ellipse?",
        "options": [
        ...
        "correctAnswer": 2,
        "solution": "For conjugate diameters of an ellipse, the product of their slopes is m<sub>1</sub>m<sub>2</sub> = -b<sup>2</sup>/a<sup>2</sup>."
    },
    {
        "type": "mcq",
        ...
        "correctAnswer": 2,
        "solution": "Tangents drawn from any point on the directrix are perpendicular, and their chord of contact always passes through the focus (it is a focal chord)."
    },
    {
        "type": "mcq",
        "text": "Area of the parallelogram formed by tangents at the ends of conjugate diameters is:",
        "options": [
            "2ab",
            "4ab",
            "ab",
        ...
        "correctAnswer": 1,
        "solution": "The area is constant and equals 4ab."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "What is the length of the focal chord of y<sup>2</sup> = 4ax making an angle &theta; with the x-axis?",
        "options": [
            "4a sin<sup>2</sup>&theta;",
            "4a cos<sup>2</sup>&theta;",
            "4a cosec<sup>2</sup>&theta;",
            "4a sec<sup>2</sup>&theta;"
        ],
        "correctAnswer": 2,
        "solution": "The length of a focal chord at angle &theta; is 4a cosec<sup>2</sup>&theta;."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "What is the equation of the pair of tangents drawn from an external point (x<sub>1</sub>, y<sub>1</sub>) to a conic?",
        "options": [
            "SS<sub>1</sub> = T",
            "SS<sub>1</sub> = T<sup>2</sup>",
            "S = T<sup>2</sup>",
    ...
    },
    {
        ...
        "correctAnswer": 0,
        "solution": "The normal is perpendicular to tangent ty = x + at<sup>2</sup>. Equation: y = -tx + 2at + at<sup>3</sup>."
    },
    {
        "type": "mcq",
    ...
    {
        "type": "mcq",
        "text": "What is the equation of the chord joining points t<sub>1</sub> and t<sub>2</sub> on the parabola y<sup>2</sup> = 4ax?",
        "options": [
            "y(t<sub>1</sub>+t<sub>2</sub>) = 2x - 2at<sub>1</sub>t<sub>2</sub>",
            "y(t<sub>1</sub>+t<sub>2</sub>) = 2x + 2at<sub>1</sub>t<sub>2</sub>",
            "x(t<sub>1</sub>+t<sub>2</sub>) = 2y + 2at<sub>1</sub>t<sub>2</sub>",
            "y(t<sub>1</sub>-t<sub>2</sub>) = 2x + 2at<sub>1</sub>t<sub>2</sub>"
        ],
        "correctAnswer": 1,
        "solution": "The chord joining (at<sub>1</sub><sup>2</sup>, 2at<sub>1</sub>) and (at<sub>2</sub><sup>2</sup>, 2at<sub>2</sub>) simplifies to y(t<sub>1</sub>+t<sub>2</sub>) = 2x + 2at<sub>1</sub>t<sub>2</sub>."
    },
    {
        "type": "mcq",
